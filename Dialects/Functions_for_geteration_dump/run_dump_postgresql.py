...
from Custom_modules.Threading import MyThread, MyThreadObj
...
def make_obj_cmd_for_bcp(path_to_pg_dump: str, connecting_settings: dict, obj_dict: dict, type_of_dump: str, out_dir: str):
    """
