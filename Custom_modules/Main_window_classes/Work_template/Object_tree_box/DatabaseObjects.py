...
class DatabaseObjectTree(QtWidgets.QWidget):
    def __init__(self,
        ...
        def on_doubleclick_tree_item(tree, json_settings: str, load_db, load_schema, load_table):
            ...
            curr_item_type = self.get_item_type(curr_item, top_lvl_item)
            ...
            try:
                ...
                if children_arr:
                    self.add_children_items(curr_item, children_arr)
            except:
    ...
    def get_item_type(item, top_item: str):
        ...
        3 - table
        """
        if top_item == 'schema' and cnt_parent != 0:
            cnt_parent += 1
    ...
    def add_children_items(self, parent_item, children: list):
        """
